...
<head>
    ...
    <title>Login - Billocity - ADVJ</title>
    <meta name="viewport"
                        ...
                        <div class="slider-light">
                            <div class="h-100 w-100" style="position: relative;">
                                ...
                                transform: translate(-30%,50%);z-index: 16;font-size:18px">
                                    Powered by, <br>
                                    <a href="https://ADVJ.in" target="_blank"
                                        style="color:#fff;text-decoration: none"><span
                                            style="font-size:32px;font-weight:bold;font-style: normal;">ADVJ
                                            Technologies</span></a>
                                </p>
                                <div class="bg-plum-plate"
                                    style="position: absolute;top: 0;bottom: 0;
                                left: 0;right: 0;z-index: 12;opacity:0.8">
                                </div>
                                <img style="position: absolute;top: 0;bottom: 0;left: 0;right: 0"
                                    src="/assets/images/citydark.jpg" class="w-100 h-100" alt="" srcset="">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input required name="email" id="exampleEmail"
