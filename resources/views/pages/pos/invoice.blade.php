...
@section('content')
    ...
    <div id="invoice" class="o-card">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <small>({{ $invoice->products->whereIn('status', ['DONE', 'CANCLED'])->sum('gst') / $invoice->products->whereIn('status', ['DONE', 'CANCLED'])->count('gst') }}
                                    %)</small>
                            </td>
                        </tr>
                        {{-- <tr>
        ...
        <p style="font-style: italic" class="ml-3">Powered by, <span style="font-weight: bold;font-style: normal">ADVJ
                Technologies</span></p>
    ...
    <script defer>
        ...
        async function printDiv() {
            ...
            document.write(
                "<link href=\"https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css\" rel=\"stylesheet\"><link href=\"../css/core.css\" rel=\"stylesheet\"><link href=\"../css/components.css\" rel=\"stylesheet\"><link href=\"../css/icons.css\" rel=\"stylesheet\">"
                )
